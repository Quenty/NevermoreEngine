...
local function CompareStrings(firstString, secondString)
	VerifyArg(firstString, "string", "firstString");
	VerifyArg(secondString, "string", "secondString");
...
local function CutoutPrefix(firstString, prefix)
	VerifyArg(firstString, "string", "firstString");
	VerifyArg(prefix, "string", "prefix");
...
lib.TrimString = StringTrim
lib.trimString = StringTrim
lib.trim_string = StringTrim
...
local GetRomanNumeral

do
	local function GetIndexFromValue(ATable, AValue)
...
NevermoreEngine.RegisterLibrary('qString', lib)