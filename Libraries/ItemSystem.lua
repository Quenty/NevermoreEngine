...
local MakeItemSystem = Class 'ItemSystem' (function(ItemSystem, Configuration, ItemClassList, Constructor, ParseConstructor)
	...
	-- Constructor will be called on Item construction. It will send the preconstructed class to the constructor, as well as any arguments passed into it..
	-- ParseConstructor will be called when parsing an old data container into a new object.
