...
local MakeLensGlare = Class 'LensGlare' (function(LensGlare, ScreenGui) 
...
local MakeLensFlare = Class 'LensFlare' (function(LensFlare, ScreenGui)
...
NevermoreEngine.RegisterLibrary('LensGlare', lib)