...
local MakeCharacterAnimationService = Class 'CharacterAnimationService' (function(CharacterAnimationService, Character)
...
NevermoreEngine.RegisterLibrary("CharacterAnimationService", lib)
