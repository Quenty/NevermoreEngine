...
--]]
	...
	local function AnimateButtonsIn()
		...
		Spawn(function()
			for Index, Button in pairs(MenuButtons) do
				Button.Gui:TweenPosition((ButtonHoverPosition + UDim2.new(0, 0, 0, ButtonHoverHeight * (Index-1))), "Out", "Elastic", 1, true)
				wait(0.125)
			end
		end)
	end
	local function AnimateButtonsOut()
		...
		for Index, Button in pairs(MenuButtons) do
			...
			delay(0.0625 * (#MenuButtons - Index), function()
				Button.Gui:TweenPosition((ButtonHoverPosition + UDim2.new(-1, 0, 0, ButtonHoverHeight * (Index-1))), "In", "Elastic", 0.5, true)
			end)
		end
	end
	...
	local function Show()
		...
		MainMenuContainer:TweenPosition(UDim2.new(0, 0, 0, 0), "Out", "Sine", 0.5, true)
		for Index, Button in pairs(MenuButtons) do
			Button.Gui.Position = ButtonHoverPosition + UDim2.new(-1, 0, 0, ButtonHoverHeight * (Index-1))
		end
	...
	local function Hide()
		...
		elseif CurrentLevels[MenuSystem.CurrentLevel].Hide then
			CurrentLevels[MenuSystem.CurrentLevel].Hide()
		end
		wait((#MenuButtons * 0.0625) + 0.5)
		MenuSystem.Closing:fire()
		MainMenuContainer:TweenPosition(UDim2.new(0, -Width, 0, 0), "Out", "Sine", 0.5, true)
	...
	function MenuSystem:AddMenuLayer(GenericMenuLevel)
		...
		for Index, Value in pairs(CurrentLevels) do
			if Value == GenericMenuLevel then
				error("MenuLevel has already been added to the MenuSystem", 2)
			end
		end
