# v7.4.0 (Thu May 09 2024)

#### 🚀 Enhancement

- Updates [#468](https://github.com/Quenty/NevermoreEngine/pull/468) ([@Quenty](https://github.com/Quenty))
- feat: Add AvatarEditorUtils.tryGetAccessoryType(avatarAssetType) ([@Quenty](https://github.com/Quenty))
- feat: better testing when prompting inventory access ([@Quenty](https://github.com/Quenty))
