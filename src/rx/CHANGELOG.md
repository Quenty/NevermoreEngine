...
- feat: Add stack tracing to subscription if desired, and check pending state ([@Quenty](https://github.com/Quenty))
- feat: Add Rx.toPromise(observable, cancelToken) ([@Quenty](https://github.com/Quenty))
