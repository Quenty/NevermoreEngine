...
describe("TimeDurationUtils.format", function()
	...
	it("should format centiseconds", function()
		expect(TimeDurationUtils.format(65.432, "mm:ss:CC", { trunc = true })).toBe("01:05:43")
		expect(TimeDurationUtils.format(65.438, "mm:ss:CC")).toBe("01:05:44")
		expect(TimeDurationUtils.format(0.05, "hh:mm:ss:CC", { trim = false })).toBe("00:00:00:05")
		expect(TimeDurationUtils.format(1.234, "s.CC.S", { trunc = true })).toBe("1.23.4")
		expect(TimeDurationUtils.format(2, "CC")).toBe("200")
		expect(function()
			TimeDurationUtils.format(1, "C __")
		end).toThrow()
	end)
