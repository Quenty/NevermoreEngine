...
# [0.20.0](https://github.com/Quenty/NevermoreEngine/compare/@quenty/studio-bridge@0.19.0...@quenty/studio-bridge@0.20.0) (2026-09-23)

**Note:** Version bump only for package @quenty/studio-bridge

# [0.19.0](https://github.com/Quenty/NevermoreEngine/compare/@quenty/studio-bridge@0.18.1...@quenty/studio-bridge@0.19.0) (2026-08-28)
...
- feat: Use yargs in studio-bridge cli ([@Quenty](https://github.com/Quenty))
- feat: Add a terminal mode to studio-bridge for easier debugging ([@Quenty](https://github.com/Quenty))
...
- feat: Add initial studio-bridge package that can replace run-in-roblox ([@Quenty](https://github.com/Quenty))
...
- refactor: plugin-template.server.lua -> StudioBridgePlugin ([@Quenty](https://github.com/Quenty))
- refactor: Handle studio brdige sessions appropriately ([@Quenty](https://github.com/Quenty))
