...
tools/nevermore-cli/templates/
  batch-test-runner.lua          # Batch test execution script
...
Example from `batch-test-runner.lua`:
```lua
...
const templatePath = resolveTemplatePath(import.meta.url, 'batch-test-runner.lua');
```
